...
# 💯 알고리즘 문제풀이 챌린지 - 2025 하반기💪
- 2025년 1월 13일(월)부터 6월 30일(월)까지 진행된 1차 챌린지는 종료되었습니다.
- 이후에는 **2025년 하반기 개발자 / AI 엔지니어** 취업 준비와 동기 부여를 목적으로 계속 진행 중입니다.
 2025년 7월 1일(화)부터는 알고리즘 및 코딩 테스트 문제 풀이를 중심으로 한 2차 챌린지를 진행 중에 있으며, 내년 2026년 1월 9일(금)까지 기한을 두고 있습니다(아마도).

## [📝이번주차 공통 문제 확인하러 가기](./problem_up_to_date.md)
...
7. 공통 문제 관련 규칙
   ...
   - [공통 문제 리스트](problem_up_to_date.md) 
```
...
<table><tr>
   ...
   <br /><sub><b>MyoungJinSon</b><br><img src="https://us-central1-progress-markdown.cloudfunctions.net/progress/61"/></sub></a><br /></td>
   ...
   <br /><sub><b>sinya3558</b><br><img src="https://us-central1-progress-markdown.cloudfunctions.net/progress/17"/></sub></a><br /></td>
</tr></table>
...
- 🎖️차준영님 깃허브🎖️ [알고리즘 문제풀이 챌린지](https://github.com/cjy8922/STU_Algorithm)